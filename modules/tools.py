...
def asc():
    ASCK = input(f"""
{W}[{N} 1 {W}]{B} Mendapatkan Password Login Page Mikrotik 
{W}[{N} 2 {W}]{B} DDoS Network 
{W}[{N} 3 {W}]{B} Tentang saya 
{W}[{N} 4 {W}]{B} Update
{W}[{N} 5 {W}]{B} Exit  
\n\n
{W}---------------------{N}
{B}{F2}Masukan Angka{N}:""")
...
Examples:
    |
    |
    |---> Masukan URL Page Login : http://a.net or 10.0.0.1
    |---> Masukan Min Number     : 72940000
    |---> Masukan MXn Number     : 72949999
...
Examples:
    |
    |
    |---> Masukan URL Untuk DDoS: http://a.net
    """
    return [S_, S2_]
